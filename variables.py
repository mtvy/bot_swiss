...
simple_oper_ids_arr   = ['281321076', '253208582', '923118950', '557561032'] 
...
collection_oper_ids_arr = ['923118950', '1670603092', '1704859354', '1778013650', '1788724487', '1527064392']
...
buttons_ru_text = {
		...
		'🙋 Оператор' : ['user'],
		'📝 Создать заказ' : ['user'],
		'🔙 Отклонить вызов оператора' : ['oper', 'admin'],
...
buttons_uz_text = {
		...
		'🙋 Operator' : ['user'],
		'📝 buyurtma yaratish' : ['user'],
		'🔙 Operator chaqiruvini rad etish' : ['oper', 'admin'],
